...
//Given a number n and a value k. From the right, set the kth bit in the binary representation of n. The position of the
// Least Significant Bit(or last bit) is 0, the second last bit is 1 and so on.
//Examples:
//
//Input: n = 10, k = 2
//Output: 14
