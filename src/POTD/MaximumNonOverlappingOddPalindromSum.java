...
//Given a string s consisting of lowercase English letters, find the maximum possible sum of the lengths of any two
// non-empty and non-overlapping palindromic substrings of odd length.
//Formally, choose any two substrings s[i...j] and s[k...l] such that 1 ≤ i ≤ j < k ≤ l ≤ s.size(), both substrings
// are palindromes of odd length, and they do not overlap. Return the maximum sum of their lengths.
//Note: A palindrome is a string that reads the same forward and backward. A substring is a contiguous sequence of
...
public class MaximumNonOverlappingOddPalindromSum {
