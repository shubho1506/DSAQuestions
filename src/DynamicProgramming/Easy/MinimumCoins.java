...
//Your task is to determine the minimum number of coins needed to obtain the target sum. If it is not possible to form
// the sum using the given coins, return -1.
//Examples:
...
public class MinimumCoins {
    public static void main(String[] args) {
        int[] coins = {9, 6, 5, 1};
        System.out.println(minCoinsTabulation(coins,19));
    }
